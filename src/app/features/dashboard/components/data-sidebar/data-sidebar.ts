...
import { CustomDropdown, DropdownOption } from '../../../../shared/components/dropdown/custom-dropdown';
...
import {AddDataSourceModal} from '../../../datasources/components/datasource-modal/add-datasource-modal';
...
@Component({
  ...
  imports: [CommonModule, CustomDropdown, AddDataSourceModal],
  templateUrl: './data-sidebar.html',
})
