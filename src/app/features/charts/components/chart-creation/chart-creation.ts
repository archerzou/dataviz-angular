...
import { ChartConfiguration } from '../chart-configuration/chart-configuration';
...
import { DropdownOption } from '../../../../shared/components/dropdown/custom-dropdown';
...
@Component({
  ...
  imports: [CommonModule, RouterModule, ChartConfiguration, ChartPreview],
  templateUrl: './chart-creation.html',
  styles: ``
})
